    ...
    <section class="page">
        <header class="page-header">
            ...
            <div class="page-actions">
                ...
                <button type="button" class="button-secondary" @click="loadAll">Atualizar</button>
            </div>
        </header>
        ...
        <div class="search-bar">
            <input
                ...
                @keyup.enter="loadAll"
            />
            <button type="button" class="button-secondary" @click="loadAll">Buscar</button>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr v-for="tcc in tccs" :key="tcc.id">
                        ...
                        <td>
                            <select v-model="tcc.status" :disabled="updatingId === tcc.id" @change="updateStatus(tcc)">
